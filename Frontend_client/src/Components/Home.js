...
const Home = () => {
  ...
  return (
    <div className='Home bg-[black] h-[100vh] flex'>
      <div className='Home-left-desc w-[50vw] flex flex-col items-center justify-center'>
        ...
        <button
          className='text-white border border-white border-2 px-4 py-2 mt-4'
          onClick={() => {
      ...
      <div className='Home-right-pic w-[50vw] flex justify-center items-center'>
